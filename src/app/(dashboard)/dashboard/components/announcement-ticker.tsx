...
export function AnnouncementTicker() {
  const announcements = [
    "ًں”¥ حقق 145 طالباً رتبة 'المحارب الفضي' اليوم!",
    "ًں“¢ مسابقة الكيمياء الكبرى تبدأ بعد 48 ساعة من الآن.",
    "ًں›،ï¸ڈ تحديث جديد لنظام الدروع الواقية (الخصوصية) متوفر الآن في الإعدادات.",
    "ًں’ژ تم مضاعفة نقاط الـ XP في مادة الفيزياء لمدة ساعتين!"
  ];
