        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-8 p-6 rounded-3xl bg-[#111114] border border-white/5">
                <h4 className="font-bold mb-4">احتاج للمساعدة؟</h4>
                <p className="text-gray-400 text-sm mb-4">إذا كان لديك أي مشكلة في عمليات الدفع أو تفعيل الاشتراك، تواصل معنا فوراً.</p>
                <button className="w-full py-3 border border-white/10 rounded-xl text-sm font-bold hover:bg-white/5 transition-all">تحدث مع الدعم الفني</button>
            </div>
          </div>
