 ...
 * NextAuth has been removed from this project in favor of custom auth (@/lib/services/auth-service).
 * 
 ...
 * @deprecated Use custom auth types from @/lib/services/auth-service instead
 */
