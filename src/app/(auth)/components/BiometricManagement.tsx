...
export default function BiometricManagement() {
  ...
  const handleSetupBiometric = async () => {
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : 'فشل إعداد المصادقة البيومترية';
      toast.error(message);
    } finally {
      setIsLoading(false);
    }
  ...
  const handleRemoveCredential = async (credentialId: string) => {
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : 'فشل إزالة جهاز المصادقة البيومترية';
      toast.error(message);
    } finally {
      setIsLoading(false);
    }
  ...
  const handleDisableBiometric = async () => {
    ...
    try {
      ...
      const message = error instanceof Error ? error.message : 'فشل تعطيل المصادقة البيومترية';
      toast.error(message);
    } finally {
      setIsLoading(false);
    }
