...
function UserProfileSidebar({ user, setActiveTab, router }: { user: UserDetails, setActiveTab: (tab: string) => void, router: any }) {
...
function UserStatsGrid({ user }: { user: UserDetails }) {
  const stats = [
...
function AcademicTab({ user }: { user: UserDetails }) {
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <Card className="border-none shadow-lg">
        <CardHeader>
...
function ActivityTab({ user }: { user: UserDetails }) {
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <Card className="border-none shadow-lg">
        <CardHeader>
