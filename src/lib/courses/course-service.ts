...
const CATEGORY_KEYWORDS: Array<{ id: string; keywords: string[] }> = [
  { id: "MATH", keywords: ["math", "—Ì«÷", "algebra", "geometry"] },
  { id: "PHYSICS", keywords: ["physics", "›Ì“Ì«¡"] },
  { id: "CHEMISTRY", keywords: ["chem", "ﬂÌ„Ì«¡"] },
  { id: "BIOLOGY", keywords: ["bio", "√ÕÌ«¡", "«ÕÌ«¡"] },
  { id: "ARABIC", keywords: ["arabic", "·€… ⁄—»Ì…", "⁄—»Ì"] },
  { id: "ENGLISH", keywords: ["english", "·€… «‰Ã·Ì“Ì…", "≈‰Ã·Ì“Ì", "«‰Ã·Ì“Ì"] },
  { id: "HISTORY", keywords: ["history", " «—ÌŒ"] },
  { id: "GEOGRAPHY", keywords: ["geo", "Ã€—«›Ì«"] },
  { id: "PHILOSOPHY", keywords: ["philosophy", "›·”›…"] },
  { id: "RELIGION", keywords: ["religion", "œÌ‰", "«”·«„", "≈”·«„"] },
  { id: "PROGRAMMING", keywords: ["program", "»—„Ã…", "coding", "code"] },
  { id: "COMPUTER_SCIENCE", keywords: ["computer", "Õ«”»", "cs", "⁄·Ê„"] },
];
...
export function mapSubjectToCourse(
  ...
  return {
    ...
    description: subject.description || "·« ÌÊÃœ Ê’› „ «Õ ·Â–Â «·œÊ—… Õ«·Ì«.",
