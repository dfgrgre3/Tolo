...
export async function analyzeSentiment(
  ...
  try {
    const prompt = `طھط­ظ„ظٹظ„ ط§ظ„ظ…ط´ط§ط¹ط± ظˆط§ظ„ط­ط§ظ„ط© ط§ظ„ط¹ط§ط·ظپظٹط© ظ„ظ„ظ†طµ ط§ظ„طھط§ظ„ظٹ ط¨ط§ظ„ط¹ط±ط¨ظٹط©. ظٹط¬ط¨ ط£ظ† طھط­ط¯ط¯:
1. ط§ظ„ظ…ط´ط§ط¹ط± ط§ظ„ط£ط³ط§ط³ظٹط©: ط¥ظٹط¬ط§ط¨ظٹطŒ ط³ظ„ط¨ظٹطŒ ظ…ط­ط§ظٹط¯طŒ ظ…ط­ط¨ط·طŒ ظ…طھط¹ط¨
2. ط¯ط±ط¬ط© ط§ظ„ظ…ط´ط§ط¹ط± ظ…ظ† -1.0 (ط³ظ„ط¨ظٹ ط¬ط¯ط§ظ‹) ط¥ظ„ظ‰ 1.0 (ط¥ظٹط¬ط§ط¨ظٹ ط¬ط¯ط§ظ‹)
3. ظ…ط³طھظˆظ‰ ط§ظ„ط«ظ‚ط© ظپظٹ ط§ظ„طھط­ظ„ظٹظ„ ظ…ظ† 0.0 ط¥ظ„ظ‰ 1.0
4. ط§ظ„ظ…ط´ط§ط¹ط± ط§ظ„ظ…ظƒطھط´ظپط©: ط¥ط­ط¨ط§ط·طŒ طھط¹ط¨طŒ طھظˆطھط±طŒ ط­ط§ظپط²طŒ ط«ظ‚ط© (ظƒظ„ ظ…ظ†ظ‡ط§ ظ…ظ† 0.0 ط¥ظ„ظ‰ 1.0)
5. ط§ظ„ظ…ط´ط§ظƒظ„ ط§ظ„ظ…ظƒطھط´ظپط© (ط¥ظ† ظˆط¬ط¯طھ)
6. ط§ظ‚طھط±ط§ط­ط§طھ ظ„ظ„ط¯ط¹ظ… (ط¥ظ† ظƒط§ظ† ظ‡ظ†ط§ظƒ ظ…ط´ط§ط¹ط± ط³ظ„ط¨ظٹط©)

ط§ظ„ظ†طµ: "${text}"

ط£ط¬ط¨ ط¨طµظٹط؛ط© JSON ظپظ‚ط· ط¨ظ‡ط°ط§ ط§ظ„ط´ظƒظ„:
{
  "sentiment": "positive|negative|neutral|frustrated|tired",
  "score": -1.0 to 1.0,
      ...
      const response = await fetch(provider.baseUrl, {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'system',
              content: 'ط£ظ†طھ ظ…طھط®طµطµ ظپظٹ طھط­ظ„ظٹظ„ ط§ظ„ظ…ط´ط§ط¹ط± ظˆط§ظ„ط¹ظˆط§ط·ظپ. ظٹط¬ط¨ ط£ظ† طھط¬ظٹط¨ ط¨طµظٹط؛ط© JSON ظپظ‚ط·.'
            },
            {
              role: 'user',
              content: prompt
