...
import { getPasskeyManager, type PasskeyAuthenticationOptions } from '@/app/(auth)/_components/passkeys/PasskeyManager';
...
export const useAlternativeLogin = () => {
    ...
    const handlePasskeyLogin = async () => {
        ...
        try {
            ...
            const options = await getPasskeyAuthenticationOptions() as PasskeyAuthenticationOptions;
