...
export function MegaMenuContainer({ children, menuWidth }: MegaMenuContainerProps) {
  ...
  return (
    <m.div
      ...
      className={cn("fixed left-1/2 -translate-x-1/2 w-full max-w-[110vw] z-50 overflow-hidden", `md:${menuWidth} lg:${menuWidth} xl:${menuWidth}`)}
      style={{ top: 'var(--header-height, 64px)', transition: 'top 0.3s ease-out' }}
    ...
    >
      <div className="relative bg-gradient-to-br from-popover/98 via-popover/95 to-popover/98 backdrop-blur-2xl rounded-b-2xl border-x border-b border-border/60 shadow-2xl shadow-black/50 overflow-hidden">
        ...
        <m.div
          ...
          animate={{ backgroundPosition: ["0% 0%", "100% 100%"], opacity: [0.6, 0.8, 0.6] }}
          transition={{ duration: 10, repeat: Infinity, repeatType: "reverse", ease: "easeInOut" }}
        />

        <m.div
          className="absolute pointer-events-none"
          style={{ left: mouseXSpring, top: mouseYSpring, translateX: "-50%", translateY: "-50%", opacity: 0.3 }}
        >
