...
export function RoyalCallModal({ open, onOpenChange, users }: RoyalCallModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl w-[95vw] h-[90vh] border-white/10 p-0 overflow-hidden bg-background/40 backdrop-blur-3xl rpg-glass-light dark:rpg-glass-premium shadow-[0_0_150px_rgba(0,0,0,0.8)] rounded-[2.5rem] sm:rounded-[3.5rem] focus:outline-none z-[100]">
        <m.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
