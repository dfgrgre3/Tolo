...
function scoreText(text) {
  ...
  const mojibake = (text.match(/[طظـØأ™أ¢أ£أ¤أ¥أ¦أ§أ¨أ©أھأ«أ¬أ­أ®أ¯أ±أ²أ³أ´أµأ¶أ¹أ؛أ»أ¼أ½أ؟]/g) || []).length;
...
function tryFixLine(line) {
  ...
  const mojibakeBefore = (line.match(/[طظـØأ™أ¢أ£أ¤أ¥أ¦أ§أ¨أ©أھأ«أ¬أ­أ®أ¯أ±أ²أ³أ´أµأ¶أ¹أ؛أ»أ¼أ½أ؟]/g) || []).length;
