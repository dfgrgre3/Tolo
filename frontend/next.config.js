...
const nextConfig = {
  ...
  async headers() {
    ...
    return [
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              '<https://iframe.mediadelivery.net>; rel=dns-prefetch',
              '<https://videodelivery.net>; rel=preconnect',
              '<https://videodelivery.net>; rel=dns-prefetch',
              '<https://cloudflarestream.com>; rel=preconnect',
              '<https://cloudflarestream.com>; rel=dns-prefetch',
              '<https://www.youtube.com>; rel=preconnect',
              '<https://www.youtube.com>; rel=dns-prefetch',
              '<https://s.ytimg.com>; rel=preconnect',
              '<https://s.ytimg.com>; rel=dns-prefetch',
            ].join(', '),
          },
          {
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://*.tolo.app https://*.vercel.app wss: ws:",
      ...
      {
        source: '/:publicRoute(about|contact|privacy|teachers|tips|pathways|library|courses)',
        headers: [
          {
            key: 'X-Frame-Options',
            value: 'SAMEORIGIN',
