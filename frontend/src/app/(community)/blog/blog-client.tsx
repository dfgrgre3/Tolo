...
interface BlogClientProps {
  /** تدوينات عامة مجمّعة من الخادم (Server Component) — تُلغي الجلب الأولي في المتصفح. */
  initialPosts?: BlogPost[];
  /** تصنيفات المدونة العامة المجمّعة من الخادم. */
...
export default function BlogClient({
  ...
  // بيانات المستخدم (userId) خاصة بالجلسة ولا تُجمَّع على الخادم —
  // تبقى تُجلب من المتصفح دائماً حتى مع وجود بيانات الخادم.
  const hasServerData = initialPosts !== undefined;
  ...
  useEffect(() => {
    ...
    // الجلب من المتصفح يحدث فقط كخطة بديلة عندما تفشل المقادير العامة
    // على الخادم (بيانات أولية غير معرّفة) — أما userId فيُجلب دائماً.
