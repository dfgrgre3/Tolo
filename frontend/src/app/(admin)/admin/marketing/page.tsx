  ...
  return (
    <div className="space-y-8 pb-10">
      <PageHeader
        ...
        description="تواصل مع جيش المحاربين بدقة. حدد الفئة المستهدفة، جهز رسالتك المحفزة، وأسقط لهم الغنائم (Loot Drops) لزيادة ارتباتم بالمنصة."
      >
          ...
          <AdminCard variant="glass" className="p-6 border-border/50 shadow-sm relative overflow-hidden">
             ...
             <form onSubmit={handleLaunchCampaign} className="space-y-6 relative z-10">
               ...
               <div className="space-y-3">
                 ...
                 <p className="text-xs text-muted-foreground font-medium">سيتم تحديد عدد المستلمين تلقائياً بالخادم عند الإطلاق.</p>
               </div>
