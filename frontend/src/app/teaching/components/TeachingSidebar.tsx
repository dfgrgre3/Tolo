 ...
 return (
  <div className="flex flex-col h-full bg-card border-l border-slate-200 dark:border-slate-800 text-right w-full">
    ...
    {menuItems.map((item) => {
     ...
     return (
      <button
       ...
       className={cn(
        "w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium  group relative",
        isActive
   ...
   <div className="p-4 border-t border-slate-100 dark:border-slate-800">
    <a
     href="/support"
     className="flex items-center gap-3 px-4 py-3 text-xs font-medium text-slate-500 hover:text-slate-900 rounded-xl hover:bg-slate-50 dark:text-slate-400 dark:hover:text-slate-200 dark:hover:bg-slate-800/40 "
    >
