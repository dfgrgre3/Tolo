...
export default function CoursesClient({
  ...
  // الجلب من المتصفح يحدث فقط كخطة بديلة عندما يفشل التجمع من الخادم
  // (بيانات أولية فارغة) — عندها تظهر الحالات التفاعلية للتحميل/الخطأ.
  useEffect(() => {
    ...
    const loadCourses = async () => {
      try {
        ...
        const { courses: mappedCourses, categories: mappedCategories } =
