                ...
                <m.div
                  ...
                  className={cn(
                    ...
                    <div className="relative h-44 overflow-hidden bg-gray-100 dark:bg-gray-800">
                      {course.thumbnailUrl ?
                    <Image src={course.thumbnailUrl} alt={course.title} fill sizes="(min-width: 1024px) 33vw, (min-width: 640px) 50vw, 100vw" className="object-cover transition-transform duration-700 group-hover:scale-110" unoptimized /> :
