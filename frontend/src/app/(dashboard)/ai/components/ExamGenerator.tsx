            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Select value={selectedSubject} onValueChange={setSelectedSubject} required>
                    <SelectTrigger className="pl-10 bg-white/5 border-white/10 rounded-2xl h-14 text-white focus:ring-blue-500/50" id="selectedSubject">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Select value={selectedYear} onValueChange={setSelectedYear} required>
                    <SelectTrigger className="pl-10 bg-white/5 border-white/10 rounded-2xl h-14 text-white focus:ring-blue-500/50" id="selectedYear">
                      <SelectValue placeholder="اختر السنة الدراسية" />
                    </SelectTrigger>
                    <SelectContent className="bg-gray-900 border-white/10 text-white">
                      {years.map((year) => (
                        <SelectItem key={year} value={String(year)}>الصف {year}</SelectItem>
                      ))}
                    </SelectContent>
                  </Select>
                </div>
              ...
              <div className="space-y-2">
                ...
                <Select value={difficulty} onValueChange={setDifficulty}>
                  <SelectTrigger className="bg-white/5 border-white/10 rounded-2xl h-14 text-white focus:ring-blue-500/50" id="difficulty">
