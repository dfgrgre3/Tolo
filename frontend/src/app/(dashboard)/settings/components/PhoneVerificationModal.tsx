    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <m.div
          ...
          <div className="p-8">
            <StepHeader step={step} phone={phone} />
...
function StepHeader({ step, phone }: { step: string; phone: string }) {
  const isSuccess = step === 'SUCCESS';
  const isOtpState = step === 'OTP' || step === 'VERIFYING';
  ...
  return (
    <div className="mb-8 text-center">
      ...
      <h3 className="text-2xl font-bold text-white">
        {isSuccess ? 'تم التحقق بنجاح' : 'تفعيل رقم الهاتف'}
      </h3>
