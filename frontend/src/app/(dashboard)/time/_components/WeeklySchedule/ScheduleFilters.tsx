...
export function ScheduleFilters({
  ...
  return (
    <div className="flex flex-wrap items-center gap-6 p-4 bg-[#0F172A]/40 backdrop-blur-xl border border-border rounded-3xl">
      <div className="flex-1 min-w-[200px] relative group">
        ...
        <Input
          ...
          className="pe-10 bg-muted/60 border-border rounded-2xl focus:ring-emerald-500/20 focus:border-emerald-500/50 transition-all font-bold"
        />
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <Select value={filterType} onValueChange={onFilterTypeChange}>
          <SelectTrigger className="w-[160px] bg-muted/60 border-border rounded-2xl font-bold focus:ring-emerald-500/20">
            <SelectValue placeholder="نوع النشاط" />
          </SelectTrigger>
          <SelectContent className="bg-[#0F172A] border-border text-slate-200">
      ...
      <div 
        className="flex items-center gap-3 px-4 py-2 bg-muted/60 border border-border rounded-2xl cursor-pointer hover:bg-muted transition-all"
