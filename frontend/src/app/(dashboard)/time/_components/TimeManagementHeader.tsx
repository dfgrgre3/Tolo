...
export default function TimeManagementHeader({
  ...
  return (
    <div className="flex flex-col gap-6 rtl relative z-10" dir="rtl">
      ...
      <div className="relative overflow-hidden flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 p-6 sm:p-8 rounded-3xl bg-background/40 backdrop-blur-2xl border border-border dark:border-border shadow-[0_8px_32px_rgba(0,0,0,0.12)] supports-[backdrop-filter]:bg-background/40">
        
        {/* Fantasy/Cyberpunk Glowing Orbs Background inside header */}
        <div className="absolute top-[-50px] right-[-50px] w-72 h-72 bg-orange-500/20 rounded-full blur-[80px] pointer-events-none mix-blend-screen" />
        ...
        <div className="space-y-4 flex-1 relative z-10 w-full lg:w-auto">
          <div className="flex items-start lg:items-center gap-4 flex-col lg:flex-row">
            {/* Player Level Badge */}
            <div
              className="relative shrink-0 w-20 h-20 rounded-2xl flex items-center justify-center bg-gradient-to-br from-orange-400 to-orange-600 shadow-[0_0_20px_rgba(249,115,22,0.3)] border-2 border-orange-300/50">
              
              <div className="text-center">
                <div className="text-xs font-bold text-orange-100/90 tracking-wider">Lvl</div>
                <div className="text-4xl font-black text-foreground leading-none tracking-tighter drop-shadow-md">
                   {gameMetrics?.level || 1}
                </div>
              </div>
              <div className="absolute -bottom-2 -right-2 bg-amber-400 p-1.5 rounded-full shadow-lg border-2 border-border/20">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <Badge variant="outline" className="bg-orange-500/10 text-orange-600 dark:text-primary-strong border-orange-500/20 shadow-[0_0_10px_rgba(249,115,22,0.2)] px-3 py-1 text-sm font-bold flex items-center gap-1.5">
              ...
              <div className="w-full max-w-md mt-2 space-y-2">
                   ...
                   <div className="relative h-2.5 w-full bg-muted/50 rounded-full overflow-hidden border border-border">
                     <div
                    className="absolute top-0 start-0 h-full bg-gradient-to-r from-orange-400 to-orange-500 rounded-full">
        ...
        <div className="flex flex-wrap gap-3 lg:gap-4 items-center relative z-10 w-full lg:w-auto">
          ...
          <div className="flex gap-2 w-full lg:w-auto justify-end mt-2 lg:mt-0">
            <Button
              ...
              disabled={refreshing}
              className="w-12 h-12 rounded-xl bg-background/50 hover:bg-muted/80 backdrop-blur-sm transition-all hover:scale-105 active:scale-95 border-border"
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {/* Card 1 */}
        <div
          className="relative overflow-hidden p-6 rounded-3xl bg-background/40 backdrop-blur-xl border border-border dark:border-border shadow-lg flex items-center justify-between group">
        ...
        <div
          ...
          <div className="relative z-10">
            <div className="text-4xl font-black text-orange-600 dark:text-orange-500 drop-shadow-[0_0_15px_rgba(249,115,22,0.5)]">{quickStats?.completedToday || 0}</div>
            <div className="text-sm font-semibold text-muted-foreground mt-1">المكتملة اليوم</div>
          </div>
          <div className="relative z-10 p-4 bg-orange-500/10 rounded-2xl border border-orange-500/20 rotate-3 group-hover:-rotate-3 transition-transform">
