      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {VALUE_PROPS.map((item) => (
            <div
              key={item.title}
              className="p-6 bg-[#F8FAFC] border border-[#E2E8F0] rounded-[12px] hover:border-[#0F766E] hover:bg-white group"
            >
              <div
                className={`h-12 w-12 rounded-xl ${item.color} flex items-center justify-center mb-4`}
              >
