        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="space-y-5">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-[#F59E0B] hover:bg-[#D97706] text-white font-black text-sm rounded-xl shadow-xl shadow-[#F59E0B]/30 transition-colors"
            >
              ابدأ التدريس الآن
