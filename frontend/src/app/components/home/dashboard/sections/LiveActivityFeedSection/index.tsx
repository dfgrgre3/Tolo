...
export const LiveActivityFeedSection = memo(function LiveActivityFeedSection() {
  ...
  return (
    <section className={`${rpgCommonStyles.glassPanel} px-6 md:px-12 py-16 shadow-2xl relative overflow-hidden group/activity`}>
      <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 via-transparent to-cyan-500/10 opacity-30 group-hover/activity:opacity-50" />
      <div className="absolute -top-24 -left-24 w-80 h-80 bg-blue-600/10 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10">
        ...
        >
          ...
          <div className="flex items-center gap-4 self-start md:self-auto px-6 py-3 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl shadow-inner group-hover/activity:border-blue-500/30">
            <div className={`h-3 w-3 rounded-full ${isLive ? 'bg-emerald-500 shadow-[0_0_15px_rgba(16,185,129,0.8)]' : 'bg-gray-400'}`} />
