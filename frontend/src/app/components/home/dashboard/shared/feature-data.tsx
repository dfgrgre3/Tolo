import { BarChart3, Bell, BookOpen, Bot, CalendarCheck, Headphones, Users, Zap } from "lucide-react";
...
export const FEATURES_LIST: FeatureItem[] = [
  ...
  { icon: <Bell className="h-6 w-6" />, title: "التنبيهات", description: "تنبيهات فورية للمهام والدروس حتى لا يفوتك أي موعد.", delay: 0.2, link: "/notifications", color: "text-red-400" },
  ...
  { icon: <BarChart3 className="h-6 w-6" />, title: "تحليل الأداء", description: "تتبع تقدمك وتحليل أدائك بتفصيل دقيق.", delay: 0.5, link: "/settings/progress", color: "text-green-400" },
