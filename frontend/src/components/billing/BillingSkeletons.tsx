...
export const CardSkeleton = () => (
  <div className="animate-pulse bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-[2rem] p-6 space-y-4">
...
export const TransactionSkeleton = () => (
  <div className="animate-pulse flex items-center justify-between p-5 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/5 rounded-[2rem]">
...
const ChartSkeleton = () => (
  <div className="animate-pulse h-[250px] w-full bg-gray-50 dark:bg-white/5 rounded-[2.5rem] p-6 border border-gray-200 dark:border-white/10 flex items-center justify-center">
...
export const WalletHeroSkeleton = () => (
  <div className="animate-pulse rounded-[3rem] bg-gray-50 dark:bg-white/5 p-8 md:p-14 border border-gray-200 dark:border-white/10">
